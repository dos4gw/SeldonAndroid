...
import com.highoncode.seldonandroid.activities.SendingActivity;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link SendingFragment.OnFragmentInteractionListener} interface
...
public class SendingFragment extends Fragment {
     ...
     *
     * @return A new instance of fragment SendingFragment.
     */
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            CountDownTimer sendingCountdown = new CountDownTimer(7000, 250) {
                @Override
                ...
                public void onFinish() {
                    ((SendingActivity)getActivity()).goToNextPage();
                }
            }.start();
        }
    }
